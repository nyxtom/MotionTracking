...
DIVE_AREAS: list[DiveArea] = [
    ...
    DiveArea("Lembeh", "ID", 1.40, 125.15, 1.55, 125.30, ("lembeh",)),
    DiveArea("Bunaken / Lembeh", "ID", 1.20, 124.40, 1.90, 125.40),
    DiveArea("Wakatobi", "ID", -5.90, 123.50, -5.20, 124.20),
    DiveArea("Banda Sea", "ID", -5.50, 129.00, -3.50, 132.00),
    DiveArea("Sipadan / Mabul", "MY", 4.05, 118.50, 4.30, 118.75, ("sipadan", "mabul")),
    ...
    DiveArea("Coron / Busuanga", "PH", 11.80, 119.90, 12.20, 120.40, ("coron", "busuanga")),
    ...
    DiveArea("Ari Atoll", "MV", 3.20, 72.60, 4.20, 73.00, ("ari",)),
    DiveArea("Baa Atoll", "MV", 4.80, 72.70, 5.40, 73.20, ("baa", "hanifaru")),
    DiveArea("North Malé Atoll", "MV", 4.00, 73.30, 4.60, 73.70, ("male", "malé")),
    ...
    DiveArea("Palau Rock Islands", "PW", 7.00, 134.10, 7.50, 134.60, ("palau", "rock islands")),
    DiveArea("Peleliu", "PW", 6.95, 134.20, 7.10, 134.30, ("peleliu",)),
    ...
    DiveArea("Darwin / Wolf", "EC", 1.30, -92.05, 1.70, -91.95, ("darwin", "wolf")),
